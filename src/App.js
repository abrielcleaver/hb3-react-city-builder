...
function App() {
  ...
  const [slogans, setSlogans] = useState(['Los Angeles brings it all together.', 'The City of Angels', 'City of Champions']);
  ...
  return (
    <div className="App">
      ...
      <div className='bottom'>
        ...
        <SloganForm setSlogan={setSlogans} />
        {/* here, the SloganList component takes the array of slogans that lives in state */}
        <SloganList slogan={slogans} />
